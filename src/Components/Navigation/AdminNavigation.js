          ...
          <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul className="navbar-nav">
              <li className="nav-item m-2">
                <Link className="nav-link" to="/admincustomermanagement">Customer Management</Link>
              </li>
              <li className="nav-item m-2">
                <Link className="nav-link" to="/adminbankemployeemanagement"> Bank Employee Management</Link>
              </li>
